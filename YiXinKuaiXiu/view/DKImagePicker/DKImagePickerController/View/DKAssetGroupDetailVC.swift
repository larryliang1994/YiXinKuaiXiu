    ...
    override func collectionView(collectionView: UICollectionView, shouldSelectItemAtIndexPath indexPath: NSIndexPath) -> Bool {
        if let firstSelectedAsset = DKImagePickerController.sharedInstance().selectedAssets.first,
            ...
            where DKImagePickerController.sharedInstance().allowMultipleTypes == false && firstSelectedAsset.isVideo != selectedAsset.isVideo {
                ...
                UtilBox.funcAlert(self, message: DKImageLocalizedStringWithKey("selectPhotosOrVideosError"), okAction: nil, cancelAction: UIAlertAction(title: DKImageLocalizedStringWithKey("ok"), style: UIAlertActionStyle.Cancel, handler: nil))
