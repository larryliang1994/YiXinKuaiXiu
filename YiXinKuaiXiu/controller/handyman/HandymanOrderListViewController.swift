...
class HandymanOrderListViewController: UIViewController, SMSwipeableTabViewControllerDelegate {
    ...
    func didLoadViewControllerAtIndex(index: Int) -> UIViewController {
        ...
        let list = storyboard.instantiateViewControllerWithIdentifier("HandymanOrderListTableViewController")
        return list
    }
